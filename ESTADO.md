...
- ✅ **Clave `GROQ_API_KEY` puesta y PROBADA EN VIVO** en `tegevem.es`: 4 preguntas, todas **< 1 s** (0,38–0,98 s) y correctas. Groq es ya el motor primario. Tevi rápido y fiable. **Estado de Tevi: COMPLETO.**
