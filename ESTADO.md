...
- ℹ️ La respuesta mala que viste ("¿Qué es SAP?" → "Sí. Implementamos…") era la **respuesta enlatada de respaldo** que aparece cuando la IA está caída (hoy: cuota gratis agotada) y emparejaba mal la pregunta. Con la IA disponible + redeploy del Worker, ahora la contesta el modelo con el prompt nuevo.
