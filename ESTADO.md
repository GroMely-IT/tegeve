...
- ⏳ **PENDIENTE (tú):** crear clave gratis en **console.groq.com** (empieza por `gsk_`) y ponerla como secreto del Worker unificado, **desde la RAÍZ del repo**: `npx wrangler secret put GROQ_API_KEY`. No requiere redeploy; en cuanto esté, Groq pasa a primario y las respuestas son ~2 s.
